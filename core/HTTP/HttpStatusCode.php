...
/**
 * DentalPRO (c) CRM
 * See https://dental-pro.online/ for license details.
 */
...
class HttpStatusCode {
    ...
    public const STATUSES = [
        ...
        self::REQUESTURI_TOO_LARGE => 'URI Too Long',
        self::UNSUPPORTED_MEDIA_TYPE => 'Unsupported Media Type',
        self::REQUESTED_RANGE_NOT_SATISFIABLE => 'Requested range unsatisfiable',
